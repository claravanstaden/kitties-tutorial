...
$ ./target/release/node-kitties --dev --base-path ./my-chain-state/
...
```shell
./target/release/node-kitties --help
```
...
template pallet that is [defined in the `pallets`](pallets/kitties/src/lib.rs) directory.
...
./scripts/docker_run.sh ./target/release/node-kitties --dev --ws-external

# Purge the local dev chain
./scripts/docker_run.sh ./target/release/node-kitties purge-chain --dev
